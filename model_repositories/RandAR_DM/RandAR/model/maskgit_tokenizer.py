...
#  https://github.com/bytedance/1d-tokenizer/blob/main/modeling/modules/maskgit_vqgan.py
...
class MaskGITTokenizer(nn.Module):
    ...
    def encode_code(self, x):
        ...
        quantized_states, codebook_indices, codebook_loss, dictances = self.quantize(hidden_states)
        return codebook_indices.detach(), dictances
...
class VectorQuantizer(nn.Module):
    ...
    def forward(self, hidden_states, return_loss=False):
        ...
        return z_q, min_encoding_indices, loss, distances
